...
function getterSetter(initialValue, validator, isClustersData) {
  var thingToGetSet = initialValue;
  var isValid = validator || function(val) { return true };
  return function(newValue) {
    if (typeof newValue === 'undefined') return thingToGetSet;
    if (isClustersData) {
      console.log('isClustersData ', isClustersData, newValue);
      thingToGetSet = newValue;
      console.log('thingToGetSet ', thingToGetSet.map(t => t.array))
      return thingToGetSet.map(t => t.array)
    }
